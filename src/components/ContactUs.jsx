      ...
      <section className="w-full flex items-end px-6 sm:px-10 lg:px-16 pb-16"
        ...
        <motion.div initial="hidden" animate="show"
          ...
          <motion.div variants={fadeUp} className="flex items-center gap-3 mb-3">
            <span className="block h-[2px] w-8 bg-[#DDB764]" />
            <span className="text-[#DDB764] text-xs font-bold tracking-[0.2em] uppercase">Contact</span>
          </motion.div>
          <motion.h1 variants={fadeUp} className="text-4xl sm:text-5xl lg:text-6xl font-black text-[#DDB764] uppercase leading-tight mb-1">
            PICKLETEO
          </motion.h1>
          <motion.div variants={fadeUp}>
            <span className="h-[11px] w-64 bg-[#DDB764] block" style={{ transform: 'skewY(-2deg)' }} />
          </motion.div>
          <motion.p variants={fadeUp} className="text-white font-bold text-xl sm:text-2xl">
            Get in touch!
          </motion.p>
        </motion.div>
      </section>
        ...
        <div className="max-w-2xl mx-auto px-6 sm:px-10 lg:px-16">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} variants={fadeUp} className="mb-8">
            <div className="flex items-center gap-3 mb-3">
              <span className="block h-[2px] w-8 bg-[#0E3E57]" />
              <span className="text-[#0E3E57] text-xs font-bold tracking-[0.2em] uppercase">Message Us</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-black text-zinc-900 uppercase">Get In <span className="text-[#DDB764]">Touch.</span></h2>
          </motion.div>
          <motion.form initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} variants={fadeUp} className="flex flex-col gap-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="text-xs font-bold uppercase tracking-widest text-zinc-500 mb-1 block">Name</label>
                <input name="name" value={form.name} onChange={handleChange}
                  className="w-full border border-white/20 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-[#DDB764] transition-colors bg-[#3B3B3B] text-white placeholder:text-white/40"
                  placeholder="Your name" />
              </div>
              <div>
                <label className="text-xs font-bold uppercase tracking-widest text-zinc-500 mb-1 block">Email</label>
            ...
            <div>
              <label className="text-xs font-bold uppercase tracking-widest text-zinc-500 mb-1 block">Location</label>
              <select name="location" value={form.location} onChange={handleChange}
                className="w-full border border-white/20 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-[#DDB764] transition-colors bg-[#3B3B3B] text-white">
            ...
            <div>
              <label className="text-xs font-bold uppercase tracking-widest text-zinc-500 mb-1 block">Message</label>
              <textarea name="message" value={form.message} onChange={handleChange} rows={5}
                className="w-full border border-white/20 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-[#DDB764] transition-colors resize-none bg-[#3B3B3B] text-white placeholder:text-white/40"
                placeholder="How can we help?" />
            </div>
            <button type="submit"
              className="bg-[#0E3E57] text-white font-bold uppercase tracking-widest text-sm px-8 py-4 rounded-lg hover:bg-[#DDB764] transition-colors">
              Send Message
            </button>
          </motion.form>
        </div>
